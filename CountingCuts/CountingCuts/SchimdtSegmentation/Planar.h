...
public:
   ...
   // Gaurav change:
   inline bool addedToNewGraph(){ return isAddedToNewGraph;}
   inline  void setAddedToNewGraph(){ isAddedToNewGraph = true;}
};
